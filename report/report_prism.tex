...
This "global shape" can be seen as "preserving the proximity relations between nodes", "preserving the orthogonal ordering of nodes"(see ref 31) or "preserving the relative positions of nodes by limiting the vertices displacement"(see Voro), and a choice between these criteria has to be made.
...
Voronoi cluster busting algo

PRISM \cite{GH08}

Since PRISM : PRISM on overlap of edges, RWordle


\bigskip
%Partie : "presentation du projet"
Our project consists in understanding the algorithm PRISM proposed by Gansner and Hu in \cite{GH08} and in analyzing the feasability of its implementation as a plugin for the Tulip software \cite{AA12}.
