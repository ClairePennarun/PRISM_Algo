...
\begin{flushright}
\small
We would like to thank M. Bruno Pinaud and M. Philippe Narbel for their interest in the project, their kindness and their availability at all times. Ans M. Ryan Herbert for his perfect english.
\end{flushright}
\end{abstract}
...
\begin{figure}[h]
  ...
  \setlength\fboxsep{5pt}
  \setlength\fboxrule{0.5pt}
  \fbox{\includegraphics[width=0.8\textwidth]{figures/overlaps.png}}
