...
In the figure \ref{scanline} we show an exemple of our algorithm \ref{scanline}. We have colored in red the graph and in green the list of bounding boxes sorted by abscissa. 
